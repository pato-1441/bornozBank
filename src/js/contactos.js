...
contacts.forEach(contacto => {    
    ...
    contenedorContactos.innerHTML+=`<label for="my-modal-${contador}" class="btn modal-button font-medium text-white">
                                        <span class="ml-1">${contacto.contactFullname}</span>
                                    </label>
                                            ...
                                            <div class="form flex flex-col items-center">
                                                ...
                                                <div class="form-control w-full max-w-xs mx-auto pt-4 pb-4" id="editContactForm">
                                                    ...
                                                    <input required type="text" placeholder="Nombre completo"
                                                            ...
                                                            maxlength="30" id="inputNameEditContact${contador}" />
                                                    <label class="label">
                                                        <span class="label-text-alt text-sm">${contacto.contactFullname}</span>                                       
                                                    </label>
                                                    ...
                                                    <input required type="text" placeholder="CBU"
                                                        ...
                                                        maxlength="22" id="inputCBUEditContact${contador}" />
                                                    <label class="label">
                                                        <span class="label-text-alt text-sm">${contacto.contactCBU}</span>                                       
                                                    </label>
                                                    ...
                                                    <input required type="text" placeholder="Alias"
                                                        ...
                                                        maxlength="40" id="inputAliasEditContact${contador}" />
                                                    <label class="label">
                                                        <span class="label-text-alt text-sm">${contacto.contactAlias}</span>                                       
                                                    </label>
                                                    <!--termina alias contacto-->
                                                    <!--boton añadir contacto-->
                                                    <div class="mt-4 flex mx-auto">
                                                        <button type="submit" id="submitEditContact"
                                                            class="btn btn-outline w-1/2 mr-1 text-white hover:text-blue-500 hover:border-blue-500 hover:bg-inherit bg-blue-500 mb-3">Modificar
                                                            contacto
                                                        </button>
